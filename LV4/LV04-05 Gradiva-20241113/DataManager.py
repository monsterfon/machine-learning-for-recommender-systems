...
class DataManager:
    ...
    # ROOT_PATH = r'F:\J_PROG_DATA\UPK\WESAD\WESAD'
    #ROOT_PATH = r'D:\\J_PROG_DATA\\D_UPK\\WESAD\\WESAD'
    #ROOT_PATH = '/media/learner/6663-3462/WESAD/'
    ROOT_PATH = r'C:\Users\user\Documents\GitHub\Faks FRI\UPK\uporabniku-prilagojena-komunikacija\LV4\LV04-05 Gradiva-20241113\WESAD'
    ...
    def extract_and_reform(self, data, subject):
        ...
        base = dict()
        stress = dict()
        print(self.RAW_SENSOR_VALUES)
        for value in self.RAW_SENSOR_VALUES: 
